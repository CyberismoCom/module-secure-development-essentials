...
Check the status of internal controls in {{#report}}"name":"xref","identifier":"secdeva_status-and-next-steps"{{/report}}. Your goal is to have no internal controls that would require attention. 
...
Check the table of security issues in that need attention in {{#report}}"name":"xref","identifier":"secdeva_status-and-next-steps"{{/report}}.
...
Check the status of automated policy checks in {{#report}}"name":"xref","identifier":"secdeva_status-and-next-steps"{{/report}}.
