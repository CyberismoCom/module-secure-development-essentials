...
This document is a review of the cybersecurity risk management for #TODO: describe scope#.
...
You can cross check your identified risks against the following checklists to ensure that you did not miss anything important:
