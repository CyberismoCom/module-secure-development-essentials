...
Major 3rd party technologies are documented as part of the threat model or directly in {{#report}}"name": "secdeva/reports/xref", "identifier": "secdeva_register_technology-assessments"{{/report}}:
