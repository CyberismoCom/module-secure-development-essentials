...
Check that Security issues affecting this version have been tracked to closure or deferred to a future release with a justified reason. See {{#report}}"name": "secdeva/reports/xref", "identifier": "secdeva_status-and-next-steps"{{/report}}.
