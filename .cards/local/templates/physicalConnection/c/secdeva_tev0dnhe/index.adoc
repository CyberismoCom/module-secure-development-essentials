...
[NOTE]
====
. Identify the potential users of the interface and check that they are represented in the threat model. See a summary above in *Classification of the interface*
