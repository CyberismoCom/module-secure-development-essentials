...
This document is a technology assessment.
...
== Conclusion on the technology assessment

The technology can be adopted for use once the following conditions are met:

* The owner of this document has filled in the technology assessment checklist and conducted the possibly required escalations, so that the identified risks can be accepted
...
for the purpose of #TODO: document the purpose#.
