...
These are the internal release notes for this release. The purpose of this document is to track in detail what has been changed and which configuration items and configuration item versions are included in the release. Software update instructions for users and stakeholders are documented in the external release notes.

#TODO: identify the new versions of your own products that this release delivers.#
...
#TODO: Add here a link or an attachment that includes the secure development related documentation for this release.#
...
#TODO: Add here links to the install package versions included in this release.#

=== Product documentation

#TODO: Add here links to the product documentation versions included in this release.#

=== Product content

#TODO: Add here links to any content that is included in this release, such as source code#
